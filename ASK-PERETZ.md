...
> **"שלושת הפאנלים — הפאנל האמצעי הוא בעצם פלטה למאחז, ובכל שלוש התמונות
> ששלחנו יש עליו מוט מסובב. הוא תמיד מגיע עם המוט? ואיזה מוט זה?"**

*מתומחר ₪660, מספר שנקבע כשחשבנו ששלושה פאנלים זה שלושה פאנלים. אם המאחז כלול
בו — וזה מה שהתמונות מראות — המחיר צריך לכלול גם אותו, ואם הוא בתוספת אז זאת
שורה נפרדת. וגם: המוט בשלוש התמונות מלוטש, ובסט הקלאסי הוא שחור. אותו מוט בשני
גימורים או שני מוצרים?*

> **"פס אנכי אחד עם פסים אופקיים חוצים אותו — ב־d047 וב־d074 זה פס מתכת, וב־d035
> וב־d066 מה שחוצה זה מוט המשיכה עצמו. שתי גרסאות של אותו דגם או שתי הזמנות
> שונות?"**

*מתומחר ₪460. ציירנו את הגרסה של d047, שבה הפס האנכי הוא פס בפני עצמו — אם
בפועל רוב הלקוחות מבקשים את הגרסה עם המוט, כדאי שהיא תהיה ברירת המחדל.*

> **"הסט הקלאסי בלי חלון — עם פאנל במקום הזכוכית. זה אותו מחיר?"**

*התמונה שקיבלנו מראה בדיוק את זה, ועכשיו אפשר לבחור את שניהם באתר. אצלנו שתי
