...
const SHOTS = [
  { name: 'phone',    w: 390,  h: 844, full: true,
    q: '?c=rb-9016d&w=rect&z=clear&g=lattice&n=idan&k=coral&d=panel&f=steel&s=standard&h=right-in&a=peep' },
  { name: 'laptop',   w: 1280, h: 720,
    q: '?c=rb-9005d&w=none&z=clear&g=none&n=channel&k=plate&d=groove&f=black&s=standard&h=right-in&a=peep' },
  { name: 'desktop',  w: 1680, h: 950,
    q: '?c=rb-6459d&w=tallwin&z=clear&g=grid&n=idan&k=coral&d=panel&f=steel&s=standard&h=right-in&a=peep' },
  { name: 'panel',    w: 1280, h: 720,
    q: '?c=rb-rb09d&w=tallwin&z=clear&g=bars&n=ella&k=almog&d=panel&f=brass&s=standard&h=right-in&a=peep,knocker' },
